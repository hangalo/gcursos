...
public class GestorImpressao {
    ...
    /**
     * Creates a new instance of GestorImpressao
     */
    ...
    public static void main(String[] args) {
        String path = "f:/projects/theschool/src/theSchool/iReport/newReport.jrxml";
        try {
            System.out.println("Loading...");
            JasperDesign jasDsgn = JRXmlLoader.load(path);
            JasperReport jasRpt = JasperCompileManager.compileReport(jasDsgn);
            JasperPrint jasPrnt = JasperFillManager.fillReport(jasRpt, new HashMap());
            JasperViewer.viewReport(jasPrnt);
            System.out.println("Done");
        } catch (Exception ex) {
            System.out.println("Cannot Load");
