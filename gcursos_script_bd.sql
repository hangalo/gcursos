...
CREATE TABLE IF NOT EXISTS `gcursos`.`instrutor` (
  ...
  `sexo_aluno` CHAR(45) NULL DEFAULT NULL,
  `telefone_princiapl` VARCHAR(45) NULL DEFAULT NULL,
  `telefone_alternativo` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `gcursos`.`pagamento` (
  ...
  INDEX `fk_pagamento_aluno1_idx` (`id_aluno` ASC),
...
-- -----------------------------------------------------
-- Table `gcursos`.`boletin_notas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gcursos`.`boletin_notas` (
  `id_boletin_notas` INT NOT NULL AUTO_INCREMENT,
  `id_aluno` INT(11) NULL,
  `id_curso` INT(11) NULL,
  `primeira_prova` DOUBLE NULL,
  `segunda_prova` DOUBLE NULL,
  `exame` DOUBLE NULL,
  PRIMARY KEY (`id_boletin_notas`),
  INDEX `fk_boletin_notas_curso1_idx` (`id_curso` ASC),
  INDEX `fk_boletin_notas_aluno1_idx` (`id_aluno` ASC),
  CONSTRAINT `fk_boletin_notas_curso1`
    FOREIGN KEY (`id_curso`)
    REFERENCES `gcursos`.`curso` (`id_curso`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `gcursos`.`certificado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gcursos`.`certificado` (
  `id_certificado` INT NOT NULL AUTO_INCREMENT,
  `data_emissao` DATE NULL,
  `local_emissao` VARCHAR(45) NULL,
  `id_aluno` INT(11) NOT NULL,
  `id_boletin_notas` INT NOT NULL,
  PRIMARY KEY (`id_certificado`),
  INDEX `fk_certificado_aluno1_idx` (`id_aluno` ASC),
  INDEX `fk_certificado_boletin_notas1_idx` (`id_boletin_notas` ASC),
  CONSTRAINT `fk_certificado_aluno1`
    FOREIGN KEY (`id_aluno`)
    REFERENCES `gcursos`.`aluno` (`id_aluno`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_certificado_boletin_notas1`
    FOREIGN KEY (`id_boletin_notas`)
    REFERENCES `gcursos`.`boletin_notas` (`id_boletin_notas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
